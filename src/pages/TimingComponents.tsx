  ...
  const fetchProducts = async () => {
    try {
      const { data, error } = await supabase
        .from('products')
        .select('*')
        .eq('category_id', '44444444-4444-4444-4444-444444444444')
        .eq('is_active', true);
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Timing Components</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Precision timing components including chains, belts, tensioners, and guides. 
            Complete kits available for most engine applications.
          </p>
        </div>
