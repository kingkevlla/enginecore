  ...
  const fetchProducts = async () => {
    try {
      const { data, error } = await supabase
        .from('products')
        .select('*')
        .eq('category_id', '33333333-3333-3333-3333-333333333333')
        .eq('is_active', true);
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Cylinder Heads</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            High-quality cylinder heads and head components. 
            Complete assemblies ready for installation with all necessary valves and springs.
          </p>
        </div>
