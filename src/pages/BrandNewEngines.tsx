  ...
  const fetchProducts = async () => {
    try {
      const { data, error } = await supabase
        .from('products')
        .select('*')
        .eq('category_id', '11111111-1111-1111-1111-111111111111')
        .eq('is_active', true);
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Brand New Engines</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover our premium collection of brand new automotive engines. 
            Each engine comes with full manufacturer warranty and professional installation support.
          </p>
        </div>
